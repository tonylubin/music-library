...
function Home() {
  return (
    <main className='col-start-3 col-end-13 row-start-1 row-end-7 bg-slate-900 overflow-auto'>
      <section className='grid grid-cols-homepage gap-10 p-12'>
        ...
        <HomeCard page={"/genres/ukg"} genre={"Uk Garage"} imgUrl={'/images/garage-genre.jpg'} />
        <HomeCard page={"/genres/garage"} genre={"Garage"} imgUrl={'/images/garagealt-genre.jpg'} />
