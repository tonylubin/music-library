...
const HomeCard = ({ genre, page, imgUrl }) => {
  return (
    <Link href={page} className="relative">
      <div className="h-52 rounded-xl flex items-center justify-center overflow-hidden  hover:scale-95 hover:bg-neutral-50 hover:opacity-80 transition duration-300 ease-in-out shadow-2xl">
